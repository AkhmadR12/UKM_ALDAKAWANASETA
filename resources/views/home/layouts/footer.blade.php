<div class="container-fluid footer py-5 wow fadeIn" data-wow-delay="0.2s">
    <div class="container py-5">
            ...
            <div class="col-lg-5">
                <div class="d-flex align-items-center justify-content-center justify-content-lg-end">
                    ...
                    <a class="btn btn-secondary btn-md-square rounded-circle me-3" href="">
                        ...
                        <i class="fab fa-instagram text-white fa-2x"></i></a>
        ...
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    <h4 class="text-white mb-4">Jam Operasi </h4>
                    <div class="mb-3">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column text-white">
                    ...
                    <a href="#"><i class="fa fa-map-marker-alt me-2"></i> Jl. Pandugo Baru XIII Blok Z No.1,
                        Penjaringan Sari, Kec. Rungkut, Surabaya, Jawa Timur 60297</a>
                    <a href="mailto:info@example.com"><i class="fas fa-envelope me-2"></i>
                        poto.group.indonesia@gmail.com</a>
                    {{-- <a href="mailto:info@example.com"><i class="fas fa-envelope me-2"></i> info@example.com</a> --}}
                    <a href="tel:+012 345 67890"><i class="fas fa-phone me-2"></i>+62 895 541 240 4193</a>
