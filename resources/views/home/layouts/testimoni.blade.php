        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
            <div class="testimonial-item text-center p-4">
                ...
                <div class="d-flex justify-content-center mb-4">
                    <img src="home/img/testimonial-1.jpg" class="img-fluid border border-4 border-primary"
            ...
            <div class="testimonial-item text-center p-4">
                ...
                <div class="d-flex justify-content-center mb-4">
                    <img src="home/img/testimonial-2.jpg" class="img-fluid border border-4 border-primary"
                        style="width: 100px; height: 100px; border-radius: 50px;" alt="">
                </div>
                <div class="d-block">
                    <h4 class="text-dark">Client Name</h4>
            ...
            <div class="testimonial-item text-center p-4">
                ...
                <div class="d-flex justify-content-center mb-4">
                    <img src="home/img/testimonial-3.jpg" class="img-fluid border border-4 border-primary"
                        style="width: 100px; height: 100px; border-radius: 50px;" alt="">
                </div>
                <div class="d-block">
                    <h4 class="text-dark">Client Name</h4>
