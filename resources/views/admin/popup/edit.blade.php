            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Popup</h3>
                                    ...
                                    <form action="{{ route('admin.popup.update', $popup->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="type" class="form-control" required>
                                                <option value="image" {{ $popup->type == 'image' ? 'selected' : '' }}>Gambar</option>
                                                <option value="video" {{ $popup->type == 'video' ? 'selected' : '' }}>Video</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3 form-check">
                                            <input type="checkbox" name="is_active" class="form-check-input" value="1" {{ $popup->is_active ? 'checked' : '' }}>
