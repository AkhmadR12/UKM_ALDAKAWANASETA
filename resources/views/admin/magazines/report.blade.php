                ...
                <div class="page-inner">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="GET" action="{{ route('magazines.report') }}" class="row">
                                        <div class="col-md-3">
                                            ...
                                            <select name="magazine_id" class="form-control">
                                                ...
                                                @foreach($magazines ?? [] as $magazine)
                                                    <option value="{{ $magazine->id }}" 
                                                        {{ request('magazine_id') == $magazine->id ? 'selected' : '' }}>
                                                        {{ $magazine->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h3 class="text-success">{{ number_format($summary['total_magazines']) }}</h3>
                                                        ...
                                                        <table class="table table-striped table-sm" id="dailyTable">
                                                            ...
                                                            <tbody>
                                                                @if(isset($daily) && count($daily) > 0)
                                                                    @foreach($daily as $magazine_id => $records)
                                                                        @foreach($records as $record)
                                                                            <tr>
                                                                                <td>{{ Str::limit($record->magazine->title ?? 'Unknown', 20) }}</td>
                                                        ...
                                                        <table class="table table-striped table-sm" id="weeklyTable">
                                                            ...
                                                            <tbody>
                                                                @if(isset($weekly) && count($weekly) > 0)
                                                                    @foreach($weekly as $magazine_id => $records)
                                                                        @foreach($records as $record)
                                                                            <tr>
                                                                                <td>{{ Str::limit($record->magazine->title ?? 'Unknown', 20) }}</td>
                                                                                <td>{{ $record->week }}</td>
                                                        ...
                                                        <table class="table table-striped table-sm" id="monthlyTable">
                                                            ...
                                                            <tbody>
                                                                @if(isset($monthly) && count($monthly) > 0)
                                                                    @foreach($monthly as $magazine_id => $records)
                                                                        @foreach($records as $record)
                                                                            <tr>
                                                                                <td>{{ Str::limit($record->magazine->title ?? 'Unknown', 20) }}</td>
                                                                                <td>{{ $record->month }}</td>
                                                        ...
                                                        <table class="table table-striped table-sm" id="yearlyTable">
                                                            ...
                                                            <tbody>
                                                                 @if(isset($yearly) && count($yearly) > 0)
                                                                    @foreach($yearly as $magazine_id => $records)
                                                                        @foreach($records as $record)
                                                                            <tr>
                                                                                <td>{{ Str::limit($record->magazine->title ?? 'Unknown', 20) }}</td>
                                                                                <td>{{ $record->year }}</td>
    ...
    <script>
        ...
        function processChartData(rawData, periodType) {
            try {
                ...
                const datasets = Object.entries(rawData).map(([magazineId, records], index) => {
                    const magazineTitle = records[0]?.magazine?.title || 'Unknown';
                    const shortTitle = magazineTitle.length > 25 
                        ? magazineTitle.substring(0, 22) + '...' 
                        : magazineTitle;
