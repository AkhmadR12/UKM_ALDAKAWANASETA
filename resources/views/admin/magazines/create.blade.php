            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">Upload Majalah Baru</div>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('magazine.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="pdf_file" class="form-label">File PDF Majalah</label>
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <a href="{{ route('magazine.index') }}" class="btn btn-secondary me-md-2">Kembali</a>
                                            <button type="submit" class="btn btn-primary">Upload Majalah</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
