                        ...
                        <form action="{{ route('portofolio.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                             ...
                             @foreach (range(1, 4) as $i)
                                <div class="mb-3">
                                    <label for="deskripsi{{ $i }}">Deskripsi {{ $i }}</label>
                                    <textarea name="deskripsi{{ $i == 1 ? '' : $i }}" class="form-control">{{ old("deskripsi" . ($i == 1 ? '' : $i)) }}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="gambar{{ $i }}">Gambar {{ $i }}</label>
                                    <input type="file" name="gambar{{ $i == 1 ? '' : $i }}" class="form-control">
                                </div>
                            @endforeach
