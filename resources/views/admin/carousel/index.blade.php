                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="{{ route('carousel.create') }}" class="btn btn-primary btn-round ms-auto">
                                        ...
                                        <table id="add-row" class="display table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $carousel->nama }}</td>
                                                    <td>
                                                        <button class="btn btn-sm toggle-status-btn {{ $carousel->status === 'aktif' ? 'btn-success' : 'btn-danger' }}" 
                                                            data-id="{{ $carousel->id }}" 
