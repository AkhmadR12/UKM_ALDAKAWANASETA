    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                @if(Auth::user()->role === 'admin' || Auth::user()->role === 'member' && Auth::user()->subdep === 'oprasional')
                ...
                @elseif(Auth::user()->role === 'member' && Auth::user()->subdep === 'perkap')
                    <li class="nav-item {{ request()->is('categories_barang') ? 'active' : '' }}">
                        <a href="{{ url('categories_barang') }}" class="collapsed" aria-expanded="false">
                            <span class="sub-item"><i class="fas fa-list"></i>
                            <p>Kategori Barang</p></span>
                ...
                {{-- @elseif(Auth::user()->role === 'member' && Auth::user()->subdep === 'oprasional') --}}
                @endif
                ...
                <li class="nav-item {{ request()->is('tamu') ? 'active' : '' }}">
                    <a href="{{ url('tamu') }}" class="collapsed" aria-expanded="false">
                        <span class="sub-item"><i class="fas fa-user"></i>
                        <p>Tamu</p></span>
                    </a>
                </li>
