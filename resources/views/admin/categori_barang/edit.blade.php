                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ route('categories_barang.update', $categori_barang->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group">
                                            <label for="name">Nama Kategori</label>
                                            <input type="text" class="form-control" id="name" name="name" required value="{{ $categori_barang->name }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Deskripsi</label>
                                            <textarea class="form-control" id="description" name="description" rows="3">{{ $categori_barang->description }}</textarea>

                                        </div>
                                         
                                        <a href="{{ route('categories_barang.index') }}" class="btn btn-danger">
