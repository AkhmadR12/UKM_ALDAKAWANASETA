                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="{{ route('tipe.create') }}" class="btn btn-primary btn-round ms-auto">
                                        ...
                                        <table id="add-row" class="display table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $tipe->nama }}</td>
                                                    {{-- <td>
                                                      <button class="btn btn-sm toggle-status-btn {{ $kategori->status === 'aktif' ? 'btn-success' : 'btn-danger' }}" 
                                                            data-id="{{ $kategori->id }}" 
                                                    ...
                                                    <td>
                                                        <img src="{{ asset($kategori->gambar) }}" alt="Member Image" width="100">
                                                    </td>                                                     
