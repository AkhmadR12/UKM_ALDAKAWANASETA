...
<body>
    ...
    <main class="main">
        <div class="checkout-container">
            ...
            <form id="cartForm" action="{{ route('order.store') }}" method="POST" enctype="multipart/form-data" class="checkout-form">
                @csrf
                            ...
                            <tbody>
                                ...
                                @foreach($cartItems as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="price-col">Rp{{ number_format($item->product->price, 0, ',', '.') }}</td>
                                        <td class="qty-col">{{ $item->quantity }}</td>
                                        <td class="subtotal-col">Rp{{ number_format($subtotal, 0, ',', '.') }}</td>
                ...
                <div class="checkout-summary">
                    <div class="summary-card">
                        ...
                        <div class="summary-row">
                            ...
                            <span class="shipping-fee">Akan dihitung</span>
                        </div>
                        ...
                        <div class="summary-row total-row">
                            ...
                            <strong class="grand-total">Rp{{ number_format($grandTotal, 0, ',', '.') }}</strong>
                        </div>
                    </div>
