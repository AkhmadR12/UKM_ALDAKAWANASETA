...
<body>
    ...
    <!-- Modal Search End -->
    <main class="main">
    <h1>Checkout Produk: {{ $product->name }}</h1>
...
<body>
    ...
    <main class="main">
        <div class="checkout-container">
            ...
            <form action="{{ route('checkout.store', $transaction->id) }}" method="POST" enctype="multipart/form-data" class="checkout-form">
                @csrf
                        ...
                        <table class="checkout-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="price-col">Rp{{ number_format($price, 0, ',', '.') }}</td>
